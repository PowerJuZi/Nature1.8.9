...
class Notification(private val message: String) {
    ...
    fun drawNotification() {
        RenderUtils.drawBorderedRect(-x-22,-20f,25f,0f,2f,Color.DARK_GRAY.rgb,Color.GRAY.rgb)
        RenderUtils.drawFilledCircle((-x-10).toInt(), -10, 10F,Color.YELLOW)
        RenderUtils.drawFilledCircle((-x-10).toInt(), -5, 3F,Color.GREEN)

        RenderUtils.drawRect(-x-11 , -18f, -x-8, -9f, Color.GREEN.rgb)
